...
dfs = pd.read_excel(r'medicines_output_medicines_en.xlsx',engine='openpyxl')
...
json.dump(info, open('meds_list_EN.json', 'w'), indent=4)
...
json.dump(info, open('meds_list_FR.json', 'w'), indent=4)
...
json.dump(info, open('meds_list_RO.json', 'w'), indent=4)
...
json.dump(info, open('meds_list_DE.json', 'w'), indent=4)
...
json.dump(info, open('meds_list_IT.json', 'w'), indent=4)